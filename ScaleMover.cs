...
public class ScaleMover : MonoBehaviour {
	...
	void Start() {
		...
		farthestScale = transform.localScale + new Vector3(xOffset, yOffset, zOffset);
	}
	...
	void Update () {
		...
		transform.localScale = Vector3.Lerp(startScale, farthestScale, lerpAmount);
	}
}
